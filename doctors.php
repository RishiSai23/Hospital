...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="img/doctor1.jpg" alt="James" width="100%" >
      <div class="container">
        <h2>Dr. Aaron Jones</h2>
        <p class="title">CEO & Founder</p>
        
        <p style="color:gold;">jane654@gmail.com</p>
        <a href="appointment.php"><button class="button">Contact</button></a>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="img/doctor3.jpg" alt="Mike" style="width:100%;">
      <div class="container">
        <h2>Dr. James Murphy</h2>
        <p class="title">Dentist</p>
       
        <p style="color:gold;">mike122@gmail.com</p>
        <a href="appointment.php"><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <a href="appointment.php"><p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
   ...
   <div class="column">
    <div class="card">
      ...
      <img src="img/doctor4.jpg" alt="Elon" width="100%" height="auto">
      <div class="container">
        <h2>Dr. Elon Musk</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="img/doctor5.jpg" alt="James" width="100%" >
      <div class="container">
        <h2>Dr. Sam Curran</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="img/doctor6.jpg" alt="Mike" style="width:100%;">
      <div class="container">
  ...
  <div class="column">
    <div class="card">
      <img src="img/doctor7.jpg" alt="Jean" style="width:100%;">
      <div class="container">
        <h2>Dr. Tom Curran</h2>
   ...
   <div class="column">
    <div class="card">
      ...
      <img src="img/doctor8.jpg" alt="Elon" width="100%" height="auto">
      <div class="container">
        <h2>Dr. Richards</h2>
